...
* Сборка на чистой, новой версии переводчика (v5.5.0-5.6.1 на момент релиза) и **BepInEx** (5.4.*, x64), без лишних/старых файлов.
* Русик основан на переводе v0.5.9+ (ранее на v0.4.4-0.4.5+), но подходит и для других версий(новых/старых) из-за автоперевода. Основной массив перевода взят от **ineith** (фри версия v0.5.6).
...
3. Не забудьте перекл. язык на инглиш в игре, если вы этого еще не сделали, чтоб ручной перевод начал действовать.
...
Ппс. Как то я больно сильно заморочился с этой фигней, хоть бы кто спс сказал, лайкнул хотя бы (звезданул чтоли 😅), а иначе забью совсем и фиг вам а не обновы 😤. Ток ходят и качают на халяву просто так. =="
### FAQ.
